...
//Eapproval third screen ...
class TransactionLine extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _TransactionLinestate();
}

class _TransactionLinestate extends State<TransactionLine>
    ...
    MySharedPreferences.instance
        ...
        .then((value) => setState(() {
              ...
              GetJSON().getTrasactionByNotifyId(GetnotifyID).then((users) {
                setState(() {
                  notifylist = users;
                  print('valueeee djkfjsd'+notifylist.length.toString());
    ...
    return Willpopwidget().getWillScope(Scaffold(
        appBar: new CustomAppBarImage(
          onPressed: () {
            Navigator.push(
              context,
              SlideLeftRoute(page: TransactionDetails()),
            );
          },
  ...
  Widget _groupedListView(List<Detailcardsitem> _gplist1) {
    return Padding(
        ...
        child: StickyGroupedListView<Detailcardsitem, int>(
          ...
          groupComparator: (int value1, int value2) => value1.compareTo(value2),
          itemComparator:
            ...
            if (element.columnPrompt.contains("Item")) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                    border: Border(
                  top: BorderSide(width: 1.0, color: Color(0xFFD5D5D5)),
                  left: BorderSide(width: 6.0, color: ReColors().appMainColor),
                  bottom: BorderSide(width: 0.5, color: Color(0xFFD5D5D5)),
                )),
                child: Column(
                  children: <Widget>[
                    Row(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(
                          '${element.columnPrompt}',
                          style: TextStyle(
                              color: Colors.grey, fontFamily: 'headingfont'),
                        ),
                        Padding(
                          padding: EdgeInsets.all(5),
                          child: Align(
                              ...
                              if (selected) {
                                ...
                                if (list[index].fileType ==
                                  ...
                                  Navigator.pushAndRemoveUntil(
                                      context,
                                      MaterialPageRoute(builder: (BuildContext context) => AttachmentsScreenApp()),
