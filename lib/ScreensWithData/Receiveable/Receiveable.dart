...
class Receivables extends StatefulWidget {
  @override
  ReceivablesState createState() => new ReceivablesState();
}

class ReceivablesState extends State<Receivables> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: new CustomAppBarImage(
          ...
          Title: 'Receivables',
          image_bar: 'assets/images/ar_logo.png',
        ),
              ...
              children: [
                InAppWebView(
                  ...
                  initialUrlRequest: URLRequest(
                      url: Uri.parse(
                          "https://artlive.artisticmilliners.com:8081/ords/art4/r/receivables-dashboard122125/home")),
