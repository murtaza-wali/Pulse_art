...
class FabricPreCosting extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FabricPreCostingState();
}

class _FabricPreCostingState extends State<FabricPreCosting> {
  @override
  void initState() {
    super.initState();
  }
