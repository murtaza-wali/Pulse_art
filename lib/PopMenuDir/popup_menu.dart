...
class PopupMenu {
  ...
  PopupMenu(
    ...
    this._backgroundColor = backgroundColor ?? ReColors().appMainColor;
    this._lineColor = lineColor ?? ReColors().appTextBlackColor;
    this._highlightColor = highlightColor ?? ReColors().appMainDarkColor;
    if (context != null) {
