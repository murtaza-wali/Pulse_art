...
class CustomAppBarImage extends StatelessWidget implements PreferredSizeWidget{
  ...
  CustomAppBarImage({this.onPressed, this.Title,this.refreshonPressed,this.image_bar});
    ...
    return AppBar(
      ...
      title: new Row(
        ...
        children: [
          ...
          Container(
              padding: const EdgeInsets.all(8.0), child: Text(Title,style: TextStyle(fontFamily: 'headerfont',fontSize: 16),))
        ],
      ),
